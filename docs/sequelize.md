...
| attributes.column | String | The description of a database column |
| attributes.column.type | String | A string or a data type |
...
| [attributes.column.unique=false] | String | If true, the column will get a unique constraint. If a string is provided, the column will be part of a composite unique index. If multiple columns have the same string, they will be part of the same unique index |
...
| [attributes.column.references] | String | If this column references another table, provide it here as a Model, or a string |
